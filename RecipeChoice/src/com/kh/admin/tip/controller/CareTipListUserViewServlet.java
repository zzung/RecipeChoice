...
@WebServlet("/careTipList.tip")
public class CareTipListUserViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public CareTipListUserViewServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Tip> careTipList = new TipService().selectCareTipListUserView(page);
