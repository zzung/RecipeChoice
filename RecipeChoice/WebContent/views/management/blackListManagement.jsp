	...
	<div class="wrap">
        ...
        <div id="content">
            <div id="content_1">
                ...
                <div id="menu_2" onclick="location.href='<%=contextPath%>/blackList.mn?page=1'" style="color:rgb(39, 174, 96)">&nbsp;&nbsp;&nbsp;블랙리스트 관리</div>
            ...
            <div id="content_2">
                ...
                <div class="pagination" align="center">
	                ...
	                <%if(pm.getNowBlock()>=2) { %>
	               	<a href="<%=contextPath%>/blackList.mn?page=<%=pm.getStartPage()-1%>">&laquo;</a>
	                <% } %>
	            	<%for(int i=0; i<pm.getEndPage(); i++){ %>
	            	<a href="<%=contextPath%>/blackList.mn?page=<%=i+1%>"><%=i+1%></a>
	            	<% } %>
	            	<%if(pm.getNowBlock()<pm.getTotalBlock()){ %>
	            	<a href="<%=contextPath%>/blackList.mn?page=<%=pm.getEndPage()+1%>">&raquo;</a>
	            	<% } %>
            	</div>      
