    ...
    <div class="wrap">
        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <div align="right">
                	<% if(m.getStatus().equals("N")){ %>
                	<a href="<%=contextPath%>/changeStatus.mn?uno=<%=m.getUserNo()%>" class="btn btn-primary">회원 활성화</a>
                	<% }else{ %>
                	<a href="<%=contextPath%>/changeStatus.mn?uno=<%=m.getUserNo()%>" class="btn btn-dark">회원 비활성화</a>
                	<% } %>
                </div>
