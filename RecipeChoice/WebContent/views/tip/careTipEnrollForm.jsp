        ...
        <div id="content">
            ...
            <div id="content_2">
				...
				<form action="insertCareTip.mn" method="post">
					<input type="hidden" id="tipType" value="1">
					
					<table class="tb2">
                    	<tbody>
	                        <tr>
	                            <th width="100px" >제목</th>
	                            <td><input type="text" id="tipTitle" style=" width: 300px; height:30px; float: left; padding-top: 5px; margin-top: 10px; margin-bottom: 10px;">&nbsp;&nbsp;&nbsp;</td>
	                        </tr>
	                        <tr>
	                            <th>간단 설명</th>
	                            <td><input type="text" id="tipInfo" style=" width: 500px; height:30px; float: left; padding-top: 5px; margin-top: 10px; margin-bottom: 10px;">&nbsp;&nbsp;&nbsp;</td>
	                        </tr>
	                        <tr>
	                            <th>연관 태그</th>
	                            <td>
	                                <select id="tipTagName" style="margin-top: 10px; margin-bottom: 10px;">
	                                    <option>소고기</option>
	                                    <option>돼지고기</option>
	                                    <option>닭고기</option>
	                                    <option>오리고기</option>
	                        ...
	                        <tr>
	                            <th>썸네일</th>
	                            <td><input type="file" id="tipPic" style="margin-top: 10px; margin-bottom: 10px;"></td>
	                        </tr>
