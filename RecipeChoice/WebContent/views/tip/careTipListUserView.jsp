        ...
        <div id="content">
            ...
            <div id="content_2">
                    ...
                    <% if(careTipList != null) { %>
                        <% for(Tip t : careTipList) { %> 
                            <div class="thumbnail">
                                ...
                                <a href="<%=contextPath%>/careTipDetail.tip?tno=<%= t.getTipNo()%>"><img src="resources/careTip_upfiles/<%= t.getTipPicture() %>" width="250" height="180"></a> <br>
				...
				<div class="pagination" align="center">
	                ...
	                <%if(pm.getNowBlock()>=2) { %>
	               	<a href="<%=contextPath%>/careTipList.tip?page=<%=pm.getStartPage()-1%>">&laquo;</a>
	                <% } %>
	            	<%for(int i=0; i<pm.getEndPage(); i++){ %>
	            	<a href="<%=contextPath%>/careTipList.tip?page=<%=i+1%>"><%=i+1%></a>
	            	<% } %>
	            	<%if(pm.getNowBlock()<pm.getTotalBlock()){ %>
	            	<a href="<%=contextPath%>/careTipList.tip?page=<%=pm.getEndPage()+1%>">&raquo;</a>
	            	<% } %>
            	</div>
