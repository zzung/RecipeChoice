	...
	<div class="wrap">
		...
		<div id="content">
			...
			<div id="content_2">
				...
				<p style="font-weight: bolder; font-size: 18px;">재료 손질법</p>
				<hr>
				<p id="order" align="right"
					style="font-size: 14px; margin-right: 30px;">
					<a href="" class="">조회순</a>&nbsp;&nbsp;&nbsp; <a href="" class="">최신순</a>
				</p>
				<hr>
				...
				<div class="listArea">
					...
					%>
					<div class="thumbnail">
						<input type="hidden" value="<%=t.getTipNo()%>"> <a
							href="<%=contextPath%>/careTipDetail.tip?tno=<%=t.getTipNo()%>"><img
							src="resources/careTip_upfiles/<%=t.getTipPicture()%>"
				...
				<div class="pagination" align="center">
					...
					%>
					<a
						href="<%=contextPath%>/careTipList.tip?page=<%=pm.getStartPage() - 1%>">&laquo;</a>
					<%
						}
					%>
					<%
					...
					%>
					<a href="<%=contextPath%>/careTipList.tip?page=<%=i + 1%>"><%=i + 1%></a>
					<%
						}
					%>
					<%
					...
					%>
					<a
						href="<%=contextPath%>/careTipList.tip?page=<%=pm.getEndPage() + 1%>">&raquo;</a>
					<%
						}
					%>
				</div>
