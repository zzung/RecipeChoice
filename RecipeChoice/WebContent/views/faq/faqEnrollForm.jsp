    ...
    <div class="wrap">
        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <h5>FAQ</h5>
                <hr>
                <form id="enrollForm" action="<%=contextPath %>/insert.mf" method="post"> 
        		 <table class="faq">
                       <tr>
                           <th ><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;제목 &nbsp;&nbsp;&nbsp;</h5></th>
                           <td colspan="4" ><input type="text" name="title" style="width:78%;" placeholder="내용을 입력하세요"required style="height:22px;"></td>
                       </tr>
                       <tr>
                           <td><h5>내용</h5></td>
                           <td>
                              <textarea name="content" cols="60" rows="6" style="resize:none; margin-top:10px; margin-bottom:10px;" required></textarea>
                           </td>
                       </tr>
                 </table>  
               	<br>
